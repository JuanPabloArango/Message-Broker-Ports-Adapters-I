...
class TestCreateDriverRequestSchema:
    ...
    def test_empty_data(self) -> None:
        ...
        data = {}
        result = CreateDriverRequestSchema().load(data)

        assert result == {"driver_id": None,
                          "last_delivery": None}, "Valide que si el request body está vacío, no falle."
    ...
    def test_not_empty_data(self) -> None:
        ...
        assert result == {"driver_id": "321",
                          "last_delivery": None}, "Valide que se pasen las validaciones."
    ...
    def test_not_empty_data_fail(self) -> None:
        ...
        with pytest.raises(ValidationError):
            CreateDriverRequestSchema().load(data)

        data = {"driver_id": "321",
                "last_delivery": dt.datetime(2025, 10, 1, 12, 0, 0)}

        with pytest.raises(ValidationError):
            CreateDriverRequestSchema().load(data)


class TestDriverResponseSchema:
    ...
    def test_succesful_single_response(self) -> None:
        ...
        result = DriverResponseSchema(many = False).load(data)
    ...
    def test_succesful_many_responses(self) -> None:
        ...
        result = DriverResponseSchema(many = True).load(data)
    ...
    def test_failed_validation(self) -> None:
        ...
        with pytest.raises(ValidationError):
            DriverResponseSchema(many = False).load(data)
